...
with DAG(
    ...
    tarea_descarga_imagen = PythonOperator(
        ...
        op_kwargs={
            ...
            "ruta_destino":"/tmp/imagenes/imagenBarca.png"
        }
    )
    ...
    crear_archivo = BashOperator(
        ...
        bash_command="""
            pwd;
            mkdir -p /opt/airflow/data/carpetaBarcelona ;
            echo "Hola, soy creado por un bash. Esta carpeta es barcelonense" > /opt/airflow/data/carpetaBarcelona/archivo.txt
            mv /tmp/imagenes/*.png /opt/airflow/data/carpetaBarcelona
        """
    )
